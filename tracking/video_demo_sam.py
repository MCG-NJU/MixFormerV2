...
from lib.test.evaluation.tracker_sam import TrackerSAM
...
def run_video(tracker_name, tracker_param, videofile='', optional_box=None, debug=None,
    ...
    args:
        ...
        debug: Debug level.
    """
    tracker = TrackerSAM(tracker_name, tracker_param, "video", tracker_params=tracker_params)
    return tracker.run_video(videofilepath=videofile, optional_box=optional_box, debug=debug, save_results=save_results)
